...
public class SearchBookFragment extends Fragment implements BorrowAdapter.OnItemClickListener {
    ...
    public void onItemClick(Book borrowItem) {
        ...
        me.arvin.ezylib.ui.fragment.universal.SearchBookFragmentDirections.ActionSearchBookFragmentToBorrowFragment action =
                me.arvin.ezylib.ui.fragment.universal.SearchBookFragmentDirections.actionSearchBookFragmentToBorrowFragment(params);
